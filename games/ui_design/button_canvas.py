...
class Button_Canvas:
    ...
    def update_image_bg(self, scale):
        ...
        image_title = Image.open(self.image_path)
        image_title = image_title.resize((round(width), round(height)), Image.LANCZOS)
    ...
    def _canvas_ok(self):
        """Return True if the canvas widget still exists (not destroyed)."""
        try:
...
# okay decompiling /Users/apple/parallel-work/decompile_workspace/ledhexagon.exe_extracted/PYZ-00.pyz_extracted/ui_design/button_canvas.pyc
