            ...
            for com in list_com:
                ...
                for coors in list(reversed(array)):
                    for k in range(2, -1, -1):
                        tuple_color = logic_2array[coors[0]][coors[1]][k]
...
def read(com, state_table, start_num, read_size=3, block=False):
    ...
    if index_of_fc > 0:
        ...
        last_idx = len_arr_before_fc - 1
        for i in range(0, len_arr_before_fc - 2, 3):
            try:
                coors = rect_position_arr[int(i / 3) + start_num]
                state_table[coors[0]][coors[1]] = arr_before_fc[last_idx - (i + 1)] == 10 or arr_before_fc[last_idx - i] == 10 or arr_before_fc[last_idx - (i + 2)] == 10
            except:
...
# okay decompiling /Users/apple/parallel-work/decompile_workspace/ledhexagon.exe_extracted/PYZ-00.pyz_extracted/led/led_control.pyc
