...
class LedControl:
    ...
    def update_wall_screen(self, array_logic, array_index):
        ...
        if self.last_com_send_data is None:
            ...
            for i in range(len(array_logic)):
        ...
        if len(list_com) > 0:
            ...
            for i in array_index:
                ...
                if text_num_send != self.last_com_send_data[i - 1]:
                    self.draw_wall_screen_by_com(address, text_num_send)
                address += 1

        self.last_com_send_data = array_logic.copy()
...
# okay decompiling /Users/apple/parallel-work/decompile_workspace/ledhexagon.exe_extracted/PYZ-00.pyz_extracted/led/led_control_c.pyc
