...
class GameRankingCanvas:
    ...
    def delete_row(self, nums, direct=1):
        if direct:
            ...
            self.list_tag = self.list_tag[:nums]
            self.row_max -= nums
...
# okay decompiling /Users/apple/parallel-work/decompile_workspace/ledhexagon.exe_extracted/PYZ-00.pyz_extracted/gui/gui_game_ranking_canvas.pyc
