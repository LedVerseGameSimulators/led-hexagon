...
class GuiCountDown:
    ...
    def __init__(self, main_obj, parent, player_num_cur=0, tourist_name="", list_player_cur=[], game_type_idx=0, game_idx=0, game_time=None, flag=0):
        ...
        # Always check is_not_interrupt (was elif — decompiler error: 'elif' prevented
        # self.next() from ever being called when parent existed, leaving a blank window)
...
# okay decompiling /Users/apple/parallel-work/decompile_workspace/ledhexagon.exe_extracted/PYZ-00.pyz_extracted/gui/gui_countdown.pyc
