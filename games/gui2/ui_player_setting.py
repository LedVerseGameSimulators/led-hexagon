        ...
        if self.list_participate is not None:
            if len(self.list_participate) > 0:
                ...
                if custom_time_left < 0:
                    messagebox.showerror((language.GAME_PROMPT), (language.GAME_INSUFFICIENT + str(result[0][-3])), parent=(self.root))
                    return
        col_idx = 0
        row_idx = num + 1
...
# okay decompiling /Users/apple/parallel-work/decompile_workspace/ledhexagon.exe_extracted/PYZ-00.pyz_extracted/gui2/ui_player_setting.pyc
