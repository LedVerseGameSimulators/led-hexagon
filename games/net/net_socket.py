...
class NetSocket:
    ...
    def __init__(self, localaddr=('127.0.0.1', 8080)):
...
# okay decompiling /Users/apple/parallel-work/decompile_workspace/ledhexagon.exe_extracted/PYZ-00.pyz_extracted/net/net_socket.pyc
