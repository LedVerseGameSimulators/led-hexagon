class Color:
    ...
    DEDUCT_COLOR = [(0xFE, 0x00, 0x30), (0xFE, 0x00, 0x30), (0xFE, 0x00, 0x30)]

    COLOR_ARR = [(0xFE, 00, 00), (00, 0xFE, 00), (00, 00, 0xFE), (0xfe, 0xfe, 00), (00, 0xfe, 0xfe), (0xfe, 00, 0xfe),
                 (0xfe, 0xfe, 0xfe)]
...
class Setting:
    ...
    FLOOR_LIGHT = 'normal_led'
    WALL_LIGHT = 'goal_led'
    SCREEN_LIGHT = 'goal2_led'
    ...
    #PARA_KEY_GAME_SETTING = 'game_setting'
    PARA_DEFAULT_GAME1 = 'default_game1'
    GAME_RESULT_DIRECTOR ='./source/'
    USE_SERIAL_HD = False   # simulator mode: no physical hardware
    FULL_SCREEN = False     # windowed mode for simulator
