...
**Related:** [ONSITE_HEX_HANDOFF.md](./ONSITE_HEX_HANDOFF.md) · [ONSITE_HEX_WORK_INDEX.md](./ONSITE_HEX_WORK_INDEX.md)

**Grid reference (GitHub):** https://github.com/LedVerseGameSimulators/led-grid · [effects_runner.py](https://github.com/LedVerseGameSimulators/led-grid/blob/main/api/effects_runner.py) · [game_manager.py](https://github.com/LedVerseGameSimulators/led-grid/blob/main/api/game_manager.py)
